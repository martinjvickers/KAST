...
seqan::ArgumentParser::ParseResult parseCommandLine(ModifyStringOptions & options, int argc, char const ** argv)
{
	...
	setDefaultValue(parser, "sequence-type", "nucl");
        addOption(parser, seqan::ArgParseOption("f", "output-format", "For Reference/query based usage you can select your output type.", seqan::ArgParseArgument::STRING, "STR"));
